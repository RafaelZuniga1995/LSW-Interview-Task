...
public class PlayerController : MonoBehaviour
{
    ...
    {
        //GetComponent<Rigidbody2D>().velocity = new Vector2(Input.GetAxisRaw("Horizontal"), Input.GetAxisRaw("Vertical")).normalized * speed * Time.fixedDeltaTime;
        ...
        GetComponent<Rigidbody2D>().velocity = Vector2.SmoothDamp(GetComponent<Rigidbody2D>().velocity, target, ref vel, 0.025f); ;
            ...
            //(Input.GetAxisRaw("Horizontal"), Input.GetAxisRaw("Vertical")).normalized * speed * Time.fixedDeltaTime;
